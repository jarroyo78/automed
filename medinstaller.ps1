...
# List of required files
$requiredFiles = @(
    @{ File = "Medicus.Xamarin.UWP_1.0.0.0_x64.cer"; Url = "https://media.githubusercontent.com/media/jarroyo78/automed/main/Medicus.Xamarin.UWP_1.0.0.0_x64.cer"; MinSize = 1KB },
    @{ File = "Microsoft.NET.CoreRuntime.2.2.appx"; Url = "https://media.githubusercontent.com/media/jarroyo78/automed/main/Microsoft.NET.CoreRuntime.2.2.appx"; MinSize = 5MB },
    @{ File = "Microsoft.NET.CoreFramework.Debug.2.2 - Copy.appx"; Url = "https://media.githubusercontent.com/media/jarroyo78/automed/main/Microsoft.NET.CoreFramework.Debug.2.2%20-%20Copy.appx"; MinSize = 8MB },
    @{ File = "Microsoft.VCLibs.x64.14.00.appx"; Url = "https://media.githubusercontent.com/media/jarroyo78/automed/main/Microsoft.VCLibs.x64.14.00.appx"; MinSize = 800KB },
    @{ File = "Microsoft.VCLibs.x64.14.00.Desktop.appx"; Url = "https://media.githubusercontent.com/media/jarroyo78/automed/main/Microsoft.VCLibs.x64.14.00.Desktop.appx"; MinSize = 6MB },
    @{ File = "Medicus.Xamarin.UWP_1.0.411.0_x64.appx"; Url = "https://media.githubusercontent.com/media/jarroyo78/automed/main/Medicus.Xamarin.UWP_1.0.411.0_x64.appx"; MinSize = 90MB }
)
